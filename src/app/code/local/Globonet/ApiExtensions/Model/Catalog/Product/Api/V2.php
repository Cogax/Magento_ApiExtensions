 ...
 */
class Globonet_ApiExtensions_Model_Catalog_Product_Api_V2 extends Mage_Catalog_Model_Product_Api_V2
{
    /**
    ...
    public function info($productId, $store = null, $attributes = null, $identifierType = null)
    {
        ...
        return Mage::getSingleton('Globonet_ApiExtensions_Model_Catalog_Product_Api')->infoResult(
            $result,
            $product,
            $standard_attributes,
            $store,
